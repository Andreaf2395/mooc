    ...
    <div class="row">
        <div class="col m2 s12">
            <div class="collection" style="margin-top: 20px;">
                <a href="/tasks/1/" class="collection-item active">Task 1</a>
                <a href="/tasks/1/" class="collection-item">Task 2</a>
                <a href="/tasks/1/" class="collection-item">Task3</a>
            </div>
        </div>
        <div class="col m10 s12">
            ...
            <div id="overview" class="col s12 ">
                <div class="card col s12 m12 " style="padding:20px;" >
            ...
            <div id="mcq" class="col s12 " >
                <div class="card col s12 m12 " style="padding-bottom:20px;">
                    <div class="section">
